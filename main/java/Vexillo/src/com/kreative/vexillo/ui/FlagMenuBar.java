...
public class FlagMenuBar extends JMenuBar {
	...
	public FlagMenuBar(FlagFrame frame) {
		...
		view.add(new SetAspectRatioMenuItem("5:3", KeyEvent.VK_5, KeyEvent.VK_B, frame, 5, 3));
		...
		view.add(new SetAspectRatioMenuItem("5:4", KeyEvent.VK_UNDEFINED, KeyEvent.VK_E, frame, 5, 4));
